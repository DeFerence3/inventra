...
class GetUnitsUseCase @Inject constructor(
    ...
    operator fun invoke(baseUnitId: Int, page: Int = 1, pageSize: Int = 100): Flow<RequestState<Paginated<Unit>>> = flow {
        ...
        try {
            ...
            val deferredResponse = repository.getUnits(baseUnitId, page, pageSize)
