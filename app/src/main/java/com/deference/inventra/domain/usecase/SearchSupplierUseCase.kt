...
class SearchSupplierUseCase @Inject constructor(
    ...
    operator fun invoke(
        ...
        page: Int,
        pageSize: Int
    ): Flow<RequestState<Paginated<Supplier>>> = flow {
        ...
        try {
            ...
            val deferredResponse = masterRepo.searchSupplier(name, page, pageSize)
