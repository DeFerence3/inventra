...
class SaveStockReceiptUseCase @Inject constructor(
    private val repository: SpotCheckRepo
) {
    operator fun invoke(body: StockReceiptRequest): Flow<RequestState<Unit>> = flow {
        ...
        try {
            ...
            val deferredResponse = repository.saveStockReceipt(body)
