...
class GetNextSerialNoUseCase @Inject constructor(
    private val repository: SpotCheckRepo
) {
    operator fun invoke(body: Map<String, String>): Flow<RequestState<SerialNo>> = flow {
        ...
        try {
            ...
            val deferredResponse = repository.getNextSerialNo(body)
