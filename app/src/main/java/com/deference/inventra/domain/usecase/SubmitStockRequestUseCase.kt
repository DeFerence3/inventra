...
class SubmitStockRequestUseCase @Inject constructor(
    private val repository: SpotCheckRepo
) {
    operator fun invoke(body: StockRequestRequestBody): Flow<RequestState<Unit>> = flow {
        ...
        try {
            ...
            val deferredResponse = repository.saveStockRequest(body)
