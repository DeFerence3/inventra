...
class SubmitSpotCheckUseCase @Inject constructor(
    private val repository: SpotCheckRepo
) {
    operator fun invoke(body: SpotCheckRequestBody): Flow<RequestState<Unit>> = flow {
        ...
        try {
            ...
            val deferredResponse = repository.submitSpotCheck(body)
