...
class SubmitPurchaseRequestUseCase @Inject constructor(
    private val repository: PurchaseRepo
) {
    operator fun invoke(body: PrRequestBody): Flow<RequestState<Unit>> = flow {
        ...
        try {
            ...
            val deferredResponse = repository.savePurchaseRequisition(body)
